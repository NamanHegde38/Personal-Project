...
public class HammerTransitionOne : StateMachineBehaviour {
    private static readonly int HammerAttack2 = Animator.StringToHash("Hammer Attack 2");
    ...
    public override void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
        ...
        animator.SetTrigger(HammerAttack2);
